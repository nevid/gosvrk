...
chart.dateFormatter.inputDateFormat = "MMM dd HH:mm:ss.AAA";

// Create axes
var dateAxis = chart.xAxes.push(new am4charts.DateAxis());
//var x_valueAxis = chart.xAxes.push(new am4charts.ValueAxis());
var valueAxis = chart.yAxes.push(new am4charts.ValueAxis());

// Create series
var series = chart.series.push(new am4charts.LineSeries());
series.dataFields.valueY = "col2";
series.dataFields.dateX = "col1";
//series.dataFields.valueX = "col0";
...
chart.dataSource.url = _url+"?"+cnt.toString();   //?cnt - anti cash
//chart.dataSource.reloadFrequency = 15000;
//chart.dataSource.parser.options.numberFields=["col0","col2"]
